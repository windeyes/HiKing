    ...
    <div class="banner-content">
            <div class="search-bar"> 
                ...
                class="search-tab">
                    ...
                    :key="index"
                    :class="{active:index === currentChoicce}"
                ...
                class="search-input">
                    <input 
                    :placeholder="searchTitle[currentChoicce].placeholder"
                    />
...
export default {
  ...
  methods: {
    searchClick(index){
      this.currentChoicce = index
      if(this.searchTitle[index].text === "机票"){
